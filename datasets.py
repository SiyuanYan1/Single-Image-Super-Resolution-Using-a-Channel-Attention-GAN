...
class SRDataset(Dataset):
    ...
    def __init__(self, data_folder, split, crop_size, scaling_factor, lr_img_type, hr_img_type, test_data_name=None):
        ...
        if test_data_name!=None:
            self.path=os.path.join(data_folder,test_data_name)
        else:
    ...
    def __getitem__(self, i):
        ...
        # script_dir="Set5/original"
        # global path
        img = Image.open(os.path.join(self.path,self.images[i]), mode='r')
        img = img.convert('RGB')
